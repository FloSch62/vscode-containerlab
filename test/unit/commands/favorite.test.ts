...
// Table-driven test cases for invalid inputs
const invalidNodeCases = [
  { description: 'does nothing when node is undefined', node: undefined },
  { description: 'does nothing when node has no labPath', node: {} },
  { description: 'does nothing when labPath has no absolute path', node: { labPath: {} } },
];
...
describe('toggleFavorite() - adding and removing', () => {
  setupFavoriteTests();
...
describe('toggleFavorite() - persistence', () => {
  setupFavoriteTests();
...
describe('toggleFavorite() - invalid inputs', () => {
  setupFavoriteTests();

  invalidNodeCases.forEach(({ description, node }) => {
