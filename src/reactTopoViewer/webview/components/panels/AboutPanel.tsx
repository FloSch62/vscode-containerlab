...
const AnimatedContainerlabLogo: React.FC = () => (
  <Box sx={{ width: 64, height: 64 }}>
      ...
      <g transform="matrix(1.27707402803300 0 0 1.27707402803300 -135.85348004729036 -121.99491568571256)">
        <g transform="matrix(1 0 0 1 0.07761382500030 0.06641805000012)">
          ...
          <g id="about-bubbles">
            ...
            >
              <g transform="scale(1,1)" id="about-mid-bubble_ts">
                <path
                  strokeWidth="0.8"
                  stroke="rgb(0,201,255)"
                  fill="none"
            ...
            >
              <g transform="scale(1,1)" id="about-big-bubble_ts">
                <path
                  strokeWidth="0.8"
                  stroke="rgb(0,201,255)"
                  fill="none"
    ...
    <style>{`
      #about-small-bubble_to {
        animation: about-small-bubble_to__to 1000ms linear infinite normal forwards;
      }
      @keyframes about-small-bubble_to__to {
        0% { offset-distance: 0%; }
        50% { offset-distance: 50%; }
        100% { offset-distance: 100%; }
      }
      #about-small-bubble {
        animation: about-small-bubble_c_o 1000ms linear infinite normal forwards;
      }
      @keyframes about-small-bubble_c_o {
        0% { opacity: 1; }
        100% { opacity: 0.68; }
      }
      #about-mid-bubble_to {
        animation: about-mid-bubble_to__to 1000ms linear infinite normal forwards;
      }
      @keyframes about-mid-bubble_to__to {
        0% { offset-distance: 0%; }
        50% { offset-distance: 50%; }
        100% { offset-distance: 100%; }
      }
      #about-mid-bubble_ts {
        animation: about-mid-bubble_ts__ts 1000ms linear infinite normal forwards;
      }
      @keyframes about-mid-bubble_ts__ts {
      ...
      #about-mid-bubble {
        animation: about-mid-bubble_c_o 1000ms linear infinite normal forwards;
      }
      @keyframes about-mid-bubble_c_o {
        0% { opacity: 1; }
        100% { opacity: 0.6; }
      }
      #about-big-bubble_to {
        animation: about-big-bubble_to__to 1000ms linear infinite normal forwards;
      }
      @keyframes about-big-bubble_to__to {
        0% { offset-distance: 0%; }
        50% { offset-distance: 50%; }
        100% { offset-distance: 100%; }
      }
      #about-big-bubble_ts {
        animation: about-big-bubble_ts__ts 1000ms linear infinite normal forwards;
      }
      @keyframes about-big-bubble_ts__ts {
        0% { transform: scale(1, 1); }
      ...
      #about-big-bubble {
        animation: about-big-bubble_c_o 1000ms linear infinite normal forwards;
      }
      @keyframes about-big-bubble_c_o {
        0% { opacity: 1; }
        100% { opacity: 0.06; }
      }
    `}</style>
