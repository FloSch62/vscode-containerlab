...
import type { CloudRFNode } from '../types';
 ...
 */
const CloudNodeComponent: React.FC<NodeProps<CloudRFNode>> = ({ id, data, selected }) => {
...
function areCloudNodePropsEqual(
  prev: NodeProps<CloudRFNode>,
  next: NodeProps<CloudRFNode>
): boolean {
