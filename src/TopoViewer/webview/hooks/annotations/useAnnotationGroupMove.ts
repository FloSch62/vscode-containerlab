...
type CyCore = {
  ...
  on: ((event: string, handler: (e: EventObject) => void) => void) & ((event: string, selector: string, handler: (e: EventObject) => void) => void);
  off: ((event: string, handler: (e: EventObject) => void) => void) & ((event: string, selector: string, handler: (e: EventObject) => void) => void);
};
